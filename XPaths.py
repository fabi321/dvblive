...
line_number_without_lineref: str = "(//TripResult[count(descendant::ServiceSection) = 1])/descendant::ServiceSection/PublishedLineName/Text/text()"
line_string_without_lineref: str = "(//TripResult[count(descendant::ServiceSection) = 1])/descendant::ServiceSection/normalize-space(RouteDescription/Text)"
line_trias_id_without_lineref: str = "(//TripResult[count(descendant::ServiceSection) = 1])/descendant::ServiceSection/LineRef/text()"
line_start_without_lineref: str = "(//TripResult[count(descendant::ServiceSection) = 1])/descendant::ServiceSection/../OriginStopPointRef/text()"#replace(., '([a-z]*:[0-9]*:[0-9]*):.*', '$1')"
line_end_without_lineref: str = "(//TripResult[count(descendant::ServiceSection) = 1])/descendant::ServiceSection/../DestinationStopPointRef/text()"#replace(., '([a-z]*:[0-9]*:[0-9]*):.*', '$1')"
